...
public class CommentDao extends AbstractMFlixDao {
	...
	public Comment addComment(Comment comment) {
		...
		try {
			...
			String errorMessage = MessageFormat.format("Error occurred while adding a new Comment `{}`: {}", comment,
					e.getMessage());
	...
	public boolean updateComment(String commentId, String text, String email) {
		...
		try {
			...
			String messageError = MessageFormat.format("Error occurred while updating comment `{}`: {}", commentId,
					e.getMessage());
	...
	public List<Critic> mostActiveCommenters() {
		...
		MongoCollection<Critic> commentCriticCollection = this.db.getCollection("comments", Critic.class)
				.withCodecRegistry(this.pojoCodecRegistry).withReadConcern(ReadConcern.MAJORITY);
